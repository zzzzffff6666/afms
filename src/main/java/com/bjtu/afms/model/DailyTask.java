...
public class DailyTask implements Serializable {
    ...
    public DailyTask(Integer id, Integer userId, Integer taskId, Date startPre, Date endPre, Date startAct, Date endAct, Integer status, Date addTime, Integer addUser, Date modTime, Integer modUser) {
        this.id = id;
        this.userId = userId;
        this.taskId = taskId;
